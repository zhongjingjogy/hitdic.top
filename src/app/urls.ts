...
export const URL_getproject: string = WEB_URL + '/getproject'
export const URL_gettasks: string = WEB_URL + '/gettasks'
export const URL_gettask: string = WEB_URL + '/gettask'
export const URL_createdtasks: string = WEB_URL + '/createdtasks'
export const URL_register: string = WEB_URL + '/register'
export const URL_authorizeusepermission: string =
